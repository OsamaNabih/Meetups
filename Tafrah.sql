...
values ("walidashraf423@gmail.com","waleed","ashraf",123,0,STR_TO_DATE('09-04-2018 00:00:00','%m-%d-%Y %H:%i:%s'),"Professional Procrastinator"); 

Insert Into Users(Email,FirstName,LastName,Password,UserType,BirthDate,Position) 
values ("OmarWagih@gmail.com","Omar","Wagih",11111,1,STR_TO_DATE('09-04-2018 00:00:00','%m-%d-%Y %H:%i:%s'),"Professional Procrastinator");
 
Insert Into Users(Email,FirstName,LastName,Password,UserType,BirthDate,Position)
values ("OsamaNabih@gmail.com","Osama","Nabih",4444,2,STR_TO_DATE('09-04-2018 00:00:00','%m-%d-%Y %H:%i:%s'),"Professional Procrastinator");
 
Insert Into Users(Email,FirstName,LastName,Password,UserType,BirthDate,Position)
values ("YasmeenAhmed@gmail.com","Yasmeen","Ahmed",5555,0,STR_TO_DATE('09-04-2018 00:00:00','%m-%d-%Y %H:%i:%s'),"Professional Procrastinator"); 
 
Insert Into Users(Email,FirstName,LastName,Password,UserType,BirthDate,Position)
values
("Speaker1@gmail.com", "Speaker2@gmail.com"),
("Speaker1FirstName", "Speaker2FirstName"),
("Speaker1LastName", "Speaker2LastName"),
("password1", "password2"),
(1, 1),
('1990-06-22', '1994-12-01'),
...
("Learner", "Lover", "Person", "Enthusiastic"),
(1234, 4321, 1111, 2222),
(2, 2, 2, 2),
('2001-06-22', '1995-04-15', '1990-06-02', '1990-04-13'),
("Student", "Junior front-end developer", "Junior back-end developer", "Machine Learning Engineer");
/*--------------------------------------------------------------------------------------------------------------------
...
Tafrah - Empowering Techies",120,"302Labs",'20180331 1:00:00 PM',"DevOps 101","Nasr City");
/*--------------------------------------------------------------------------------------------------------------------
Attaching speakers to meetups*/
Insert Into Spoke_In(SpeakerID, MeetupID)
values
(2, 5, 6, 2, 5, 6, 2, 5, 6, 2, 5, 6, 5, 6, 5),
(8, 8, 8, 9, 9, 9, 1, 1, 1, 2, 3, 4, 5, 6, 2);
/*--------------------------------------------------------------------------------------------------------------------
Attaching attendees to meetups*/
Insert Into Attended(AttendeeID, AttendedEventID)
values
(3, 7, 8, 9, 10, 3, 7, 8, 9, 10, 3, 7, 8, 9, 10, 3, 7, 8, 9, 10, 3, 10),
(8, 8, 8, 8, 8, 9, 9, 9, 9, 9, 1, 1, 2, 2, 3, 5, 5, 5, 6, 6, 7, 7);